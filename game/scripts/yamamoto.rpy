...
label yamamotoChapter1:
    ...
    "My father beams with pride, though his mood deflates slightly upon noticing
      the amount of guests there are."
    ...
    h "\"Dad, what--\""
    "Yamamoto, already dressed in my father's cooking apron, was showing off
      his skills with a blade and slicing through the fish like a mad man."
    ...
    yama "\"My dad taught me kendo to strengthen my self-control. We then
      switched to actual swords once I enrolled to become part of the Vongola.\""
    h "\"Vongola?\""
    ...
    "Out of nowhere, he brushes a thumb against the corner of my lips.
      I glance up from my food and get caught in his gaze."
    ...
    yama "\"No, I need to take on some responsibilities since I’ll be
      staying here. I don’t want to be freeloading off you and the princess.\""
    ...
    "Honestly, I still couldn’t believe I was one, but sooner or
      later, I was going to have to get with the program."
    stop music
    ...
    stop music
    play music "music/Holiday.mp3" loop
    "I turn my head to find Gokudera staring oddly at me. He’s seated at the
      window seat, arms crossed and boredom written all over his face."
    menu:
        "\"Where is Yamamoto?!\"":
